...
export default function Home() {
  return (
    <div className="bg-white dark:bg-slate-950">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-violet-600 to-indigo-800 dark:from-violet-900 dark:to-indigo-950">
        {/* Animated background elements */}
        <div className="absolute inset-0 overflow-hidden opacity-20">
          <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-purple-400 blur-3xl"></div>
          <div className="absolute top-60 -left-20 h-72 w-72 rounded-full bg-blue-400 blur-3xl"></div>
          <div className="absolute bottom-20 right-32 h-64 w-64 rounded-full bg-indigo-400 blur-3xl"></div>
        </div>
        <div className="container relative z-10 mx-auto px-6 py-24 sm:px-8 lg:py-32">
          <div className="flex flex-col items-center gap-16 lg:flex-row lg:gap-12">
            <div className="w-full space-y-8 text-center lg:w-1/2 lg:text-left">
              <div className="space-y-4">
                <div className="inline-block rounded-full bg-white/10 px-4 py-1 backdrop-blur-sm">
                  <p className="text-sm font-medium text-white">Open Source AI Agent Ecosystem</p>
                </div>
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
                  <span className="block font-extrabold">BLAH</span>
                  <span className="mt-1 block text-2xl font-semibold text-indigo-200 sm:text-3xl md:text-4xl">Barely Logical Agent Host</span>
                </h1>
              </div>
              <p className="mx-auto text-xl text-indigo-100 lg:mx-0">
                A powerful ecosystem for managing, distributing, and executing AI agent tools using the Model Context Protocol (MCP).
              </p>
              <div className="flex flex-wrap justify-center gap-4 lg:justify-start">
                <Button size="lg" className="gap-2 bg-white font-medium text-indigo-700 hover:bg-white/90 hover:text-indigo-800">
                  <Link href="/schema" className="flex items-center gap-2">
                    Explore Schema
                    <ArrowRight className="h-4 w-4" />
                  </Link>
                </Button>
                <Button variant="outline" size="lg" className="gap-2 border-white/30 bg-white/10 font-medium text-white backdrop-blur-sm hover:bg-white/20 hover:text-white">
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative mx-auto aspect-square max-w-md">
                {/* Glowing orb with animated rings */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="absolute h-64 w-64 animate-pulse-slow rounded-full bg-indigo-500/20 blur-xl"></div>
                  <div className="absolute h-56 w-56 animate-pulse-slow rounded-full bg-violet-500/30 blur-lg"></div>
                  <div className="relative flex h-48 w-48 items-center justify-center rounded-full bg-gradient-to-br from-indigo-400 to-purple-600 p-1 shadow-lg shadow-indigo-500/50">
                    <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 to-purple-800">
                      <div className="text-7xl">🔮</div>
                    </div>
                  </div>
                  {/* Orbiting elements */}
                  <div className="absolute h-72 w-72 animate-[spin_15s_linear_infinite] rounded-full border border-white/10">
                    <div className="absolute -left-2 top-1/2 h-4 w-4 -translate-y-1/2 rounded-full bg-blue-400 shadow-lg shadow-blue-400/50"></div>
                  </div>
                  <div className="absolute h-96 w-96 animate-[spin_25s_linear_infinite_reverse] rounded-full border border-white/10">
                    <div className="absolute -right-2 top-1/2 h-4 w-4 -translate-y-1/2 rounded-full bg-purple-400 shadow-lg shadow-purple-400/50"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Wave divider */}
        <div className="absolute bottom-0 left-0 right-0 h-16 bg-white dark:bg-slate-950">
          <svg className="absolute bottom-0 h-16 w-full" preserveAspectRatio="none" viewBox="0 0 1440 54" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 0L48 5.47826C96 10.9565 192 21.913 288 27.3913C384 32.8696 480 32.8696 576 29.6304C672 26.3913 768 21.913 864 18.6739C960 15.4348 1056 13.0435 1152 16.2826C1248 19.5217 1344 27.3913 1392 31.6522L1440 35.913V54H1392C1344 54 1248 54 1152 54C1056 54 960 54 864 54C768 54 672 54 576 54C480 54 384 54 288 54C192 54 96 54 48 54H0V0Z" fill="currentColor"/>
          </svg>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center">
            <div className="mb-3 inline-block rounded-full bg-indigo-100 px-3 py-1 text-sm font-medium text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300">Features</div>
            <h2 className="mb-4 text-4xl font-bold tracking-tight dark:text-white">Powerful AI Agent Ecosystem</h2>
            <p className="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-400">Build, share, and execute agent tools with our comprehensive platform</p>
          </div>
          
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            {/* Feature 1 */}
            <div className="group relative">
              <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 opacity-0 blur transition duration-300 group-hover:opacity-100"></div>
              <div className="relative h-full rounded-xl bg-white p-6 shadow-xl transition-all duration-300 dark:bg-slate-900 dark:shadow-slate-800/50 group-hover:translate-y-[-4px]">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-indigo-100 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400">
                ...
                <h3 className="mb-2 text-xl font-bold dark:text-white">MCP Compatible</h3>
                <p className="mb-4 text-slate-600 dark:text-slate-400">
                  Seamlessly integrates with any system that supports the Model Context Protocol, including Claude Desktop, Cursor, and more.
                </p>
            ...
            {/* Feature 2 */}
            <div className="group relative">
              <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-purple-500 to-pink-600 opacity-0 blur transition duration-300 group-hover:opacity-100"></div>
              <div className="relative h-full rounded-xl bg-white p-6 shadow-xl transition-all duration-300 dark:bg-slate-900 dark:shadow-slate-800/50 group-hover:translate-y-[-4px]">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="mb-2 text-xl font-bold dark:text-white">Tool Registry</h3>
                <p className="mb-4 text-slate-600 dark:text-slate-400">
            ...
            {/* Feature 3 */}
            <div className="group relative">
              <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-r from-pink-500 to-rose-600 opacity-0 blur transition duration-300 group-hover:opacity-100"></div>
              <div className="relative h-full rounded-xl bg-white p-6 shadow-xl transition-all duration-300 dark:bg-slate-900 dark:shadow-slate-800/50 group-hover:translate-y-[-4px]">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="mb-2 text-xl font-bold dark:text-white">Secure & Open</h3>
                <p className="mb-4 text-slate-600 dark:text-slate-400">
