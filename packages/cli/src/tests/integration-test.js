...
const integrationTestDir = path.resolve(__dirname, '../../integration-tests/test-flow');
...
if (isCI) {
  ...
  describe('Flow Editor Integration Tests', () => {
    ...
    beforeAll(() => {
      ...
      fs.writeFileSync(blahJsonPath, JSON.stringify(minimalBlahJson, null, 2), 'utf8');
    });
    ...
    it('should create flows array in existing blah.json', async () => {
      ...
      try {
        ...
        const updatedBlahJson = JSON.parse(fs.readFileSync(blahJsonPath, 'utf8'));
